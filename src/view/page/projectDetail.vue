              ...
              <div v-else>
                ...
                <form>
                  <div style="padding: 10px 20px 30px 20px;">
                    ...
                    <button @click="logAddForm()"class="waves-effect waves-teal btn-flat edit" style="color:#41B883;font-size:9pt;float:right;">취소</button>                
                    <button @click="logAddForm()"class="waves-effect waves-teal btn-flat edit" style="color:#41B883;font-size:9pt;float:right;">확인</button> 
            ...
            <div v-for="log in logData">
              <div id="logMemo">
                  <div class="card" style="width:100%;min-height:150px;">
                      ...
                      <div style="padding: 10px 20px 30px 20px;" :id="'memoKey'+log.id">
                          
                          <!-- 작성자 view 상태-->
                          <div class="view" >
                            <b><span style="color:#424242">{{log.writer}}</span></b>
                            <!-- 작성일 -->
                          ...
                          <div class="row">
                            <div class="col s6">
                              ...
                              <input type="text" v-bind:value="log.writer"/>
                              </div>                            
                            </div>
                          </div>
                          ...
                          <div class="row">
                              <!-- 본문 view 상태-->                    
                              <div class="view col s12" style="margin-top:10px;">
                                {{log.detail}}
                              </div>
                              ...
                              <div class="edit" style="display:none;">
                                <div class="input-field col s12">
                                  <textarea id="textarea2" class="materialize-textarea" data-length="120" style="font-size:10pt;">{{log.detail}}</textarea>
                                </div>                                     
                              </div>
                          </div>
                            ...
                            <button @click="logDelForm(log.id)"class="waves-effect waves-teal btn-flat view" style="color:#41B883;font-size:9pt;float:right;">삭제</button>    
                            <button @click="logUpdateForm(log.id)"class="waves-effect waves-teal btn-flat view" style="color:#41B883;font-size:9pt;float:right;">수정</button>  
                            <button @click="logConfirm(log.id)"class="waves-effect waves-teal btn-flat edit" style="color:#41B883;font-size:9pt;float:right; display:none;">취소</button>   
                            <button @click="logConfirm(log.id)"class="waves-effect waves-teal btn-flat edit" style="color:#41B883;font-size:9pt;float:right; display:none;">확인</button>
